...
public final class ConstantesValidaciones {
 ...
 // Labels permisos bodega
    ...
    public static final String CANTIDAD_BLOQUES = PropertiesUtil.getProperty("lbl.bodega.crear.cantidadBloques");
    public static final String CUERPO_X_BLOQUE = PropertiesUtil.getProperty("lbl.bodega.crear.cantidadCuerposXBloque");
    public static final String ESTANTE_X_CUERPO = PropertiesUtil.getProperty("lbl.bodega.crear.cantidadEstantesXCuerpo");
    public static final String ENTREPANO_ESTANTE = PropertiesUtil.getProperty("lbl.bodega.crear.cantidadEntrepanoXEstante");
